...
public class MenuPrincipal extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button boton1 = (Button) rootView.findViewById(R.id.btn1);
        Button boton2 = (Button) rootView.findViewById(R.id.btn2);
        Button boton3 = (Button) rootView.findViewById(R.id.btn3);
        Button boton4 = (Button) rootView.findViewById(R.id.btn4);
        Button boton5 = (Button) rootView.findViewById(R.id.btn5);
